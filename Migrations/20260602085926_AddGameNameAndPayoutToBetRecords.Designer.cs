...
namespace CasinoRoyale.Migrations
{
    ...
    [Migration("20260602085926_AddGameNameAndPayoutToBetRecords")]
    partial class AddGameNameAndPayoutToBetRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CasinoRoyale.Models.BaccaratGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BankerHandJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("BankerValue")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CasinoRoyale.Models.DiceGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CasinoRoyale.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CasinoRoyale.Models.Wallet", b =>
                {
                    b.HasOne("CasinoRoyale.Models.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("CasinoRoyale.Models.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
